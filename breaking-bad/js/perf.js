...
import { floraDensity } from './world/flora.js';
...
const TIERS = [
  { name: 'low', pr: 1, gtao: false, bloom: false, smaa: true, shadow: 2048, flora: .45 },
  { name: 'medium', pr: 1.25, gtao: false, bloom: true, smaa: true, shadow: 2048, flora: .75 },
  { name: 'high', pr: 1.5, gtao: true, bloom: true, smaa: true, shadow: 4096, flora: 1 },
  { name: 'ultra', pr: 2, gtao: true, bloom: true, smaa: true, shadow: 4096, flora: 1 },
];
...
export function applyTier(i) {
  ...
  resizePost();
  /* the grass, far shrubs and stones thin out on the lower tiers */
  app.density = t.flora; floraDensity(app.place?.flora, t.flora);
